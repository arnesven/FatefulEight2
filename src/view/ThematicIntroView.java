...
public class ThematicIntroView extends GameView implements Animation {
    ...
    private String[] text = new String[]{
            "Deep in the forest, our heroes finally found the lost temple.",
            ...
            "",
            "\"Gold and glory, right?\" grumbled Bungo Darkwood, the group's",
            "professional thief.",
            "\"Well, a few aggressive lizardmen are to be expected when you're",
            "hunting treasure,\" replied the group's leader, the noble",
            "knight Denise Boyd.",
            "",
            "The archer Rolf Fryt slowly drew an arrow from his quiver.",
            "\"I prefer lizardmen over frogmen. At least they understand what",
            "we're saying. Maybe we won't have to resort to violence this time.\"",
            "",
