...
public class TopText {
    ...
    public void drawYourself(Model model) {
        ...
        model.getScreenHandler().put(31, 0, REP_ICON_SPRITE);
        BorderFrame.drawString(model.getScreenHandler(), String.format("%2d", model.getParty().getReputation()), 29, 0, MyColors.WHITE);
        drawKeyTexts(model);
    }
