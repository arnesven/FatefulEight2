...
public class DoublePortraitSubView extends SubView {
    ...
    protected void drawArea(Model model) {
        ...
        partyAnimations.drawBlink(model.getScreenHandler(), leftApp, CHAR_LOCATION_LEFT);
        rightApp.drawYourself(model.getScreenHandler(), X_MAX-12, Y_OFFSET+9);
        partyAnimations.drawBlink(model.getScreenHandler(), rightApp, CHAR_LOCATION_RIGHT);
