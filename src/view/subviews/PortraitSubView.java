...
public class PortraitSubView extends SubView {
    ...
    public static AdvancedAppearance makeRandomPortrait(CharacterClass cls, Race race, boolean gender) {
        ...
        if (beard.isTrueBeard() && beard.meetsSideburns()) {
            System.out.print("True beard with ");
            if (MyRandom.flipCoin()) {
                System.out.println("sideburns!");
                eyes = MyRandom.flipCoin() ? new SmallEyesWithSideburns() : new BaggySmallEyesWithSideburns();
            } else {
                System.out.println("no sideburns :(");
            }
        }
    ...
    protected void drawArea(Model model) {
        ...
        model.getScreenHandler().clearForeground(X_OFFSET+5, X_OFFSET+15+PORTRAIT_FRAME_WIDTH,
