...
public class TutorialSkillChecksDialog extends ExpandableHelpDialog {
    ...
    public static final String SOLO_TEXT =
            "In a Solo Skill Check one party member must perform the skill check alone.";

    public static final String COLLECTIVE_TEXT =
    ...
    public static final String COLLABORATIVE_TEXT =
    ...
    public static final String REACTIVE_TEXT = "Reactive Skill Checks occur in a reaction to something happening. " +
    ...
    public static final String SYNERGY_TEXT = "Sometimes a Skill Check in one skill may will gain a bonus from another. " +
