...
public class PickPocketing extends HelpDialog {
    private static final String TEXT =
            ...
            DarkDeedsEvent.PICK_POCKETING_BASE_SNEAK_DIFFICULTY + " plus the mark's ranks of perception. " +
            "Should the first check be " +
            "successful the next test is against Security with a difficulty of " +
            DarkDeedsEvent.PICK_POCKETING_BASE_SECURITY_DIFFICULTY + " plus the mark's level.\n\n"+
