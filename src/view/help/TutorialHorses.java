...
public class TutorialHorses extends HelpDialog {
    private static final String TEXT =
            ...
            "Horses can be bought and sold at inns and taverns. There are two types of horses, full-bloods and ponies. " +
            "Halflings and dwarves can only ride on full-bloods together with another non-halfling, non-dwarf character. " +
            ...
            "the number of full bloods and the digit to the right is the number of ponies you have. " +
