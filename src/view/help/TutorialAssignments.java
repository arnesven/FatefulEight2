...
import model.headquarters.TownWorkingAssignees;
...
public class TutorialAssignments extends SubChapterHelpDialog {
    private static final String TEXT = "If your leader has at least " +
            ...
            "This expends 1-2 Stamina for the character and can generate up to " + TownWorkingAssignees.MAX_GOLD_FROM_WORK +
