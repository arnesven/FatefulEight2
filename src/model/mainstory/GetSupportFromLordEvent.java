...
public abstract class GetSupportFromLordEvent extends VisitLordEvent {
    ...
    protected void doEvent(Model model) {
        ...
        if (model.getParty().size() > 1) {
            ...
            portraitSay("Oh, it's you. I've heard of you, " + model.getParty().getLeader().getFullName() + ", right?", FacialExpression.questioning);
        ...
        portraitSay("It's well known you are " + agent + " of the now infamous " +
                ...
                ". State your business quickly before you are thrown out!", FacialExpression.disappointed);
        leaderSay("Actually, " + imOrWere() + " persona non grata in " + CastleLocation.placeNameShort(kingdom.getPlaceName()) +
                " at the moment.", FacialExpression.disappointed);
        portraitSay("How interesting. What happened?", FacialExpression.questioning);
        ...
        portraitSay("So you've come to seek asylum in this kingdom?", FacialExpression.questioning);
        ...
        portraitSay("My help? What do you expect me to do?", FacialExpression.disappointed);
        ...
        portraitSay("That's a ludicrous plan, it'll never work.", FacialExpression.disappointed);
        ...
        portraitSay("You think you can ally with the " + model.getMainStory().getRemotePeopleName() + "? That would be impressive...", FacialExpression.questioning);
        ...
        leaderSay("Of course. What is it?", FacialExpression.questioning);
        ...
        leaderSay("Thank you. You won't regret this.", FacialExpression.relief);
        portraitSay("Good bye, and good luck!");
        task.progress();
    }
}
