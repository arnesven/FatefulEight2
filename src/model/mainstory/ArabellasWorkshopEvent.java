...
public class ArabellasWorkshopEvent extends DailyEventState {
    ...
    protected void doEvent(Model model) {
        ...
        portraitSay("When I installed my little gas trap I never thought you would be the one" +
                (model.getParty().size() > 1 ? "s" : "") + " to fall into it.", FacialExpression.wicked);
        if (model.getParty().size() > 1) {
            println("You can see the rest of the party members have also been " +
                    "tied to rings in the workshop walls.");
        }
        leaderSay("You must be Arabella.", FacialExpression.disappointed);
        portraitSay("Bravo, at least you've caught on there.", FacialExpression.wicked);
        ...
        portraitSay("Hehe, actually I think you might be wrong there. But I should give you some credit. I " +
                ...
                "after what I did to it.", FacialExpression.wicked);
        leaderSay("So it was you who enchanted it! " + iOrWeCap() + " should have known.", FacialExpression.disappointed);
        portraitSay("Enchanted? I guess that's one way of describing it...", FacialExpression.questioning);
        ...
        portraitSay("Yes. And by then I had plenty of test subjects...", FacialExpression.wicked);
        ...
        portraitSay("The arcane magic of the Quad radiates a peculiar aura. Natives from the region were " +
        ...
        if (caid != null) {
            partyMemberSay(caid, "We should have locked you up and thrown away the key when we had the chance!", FacialExpression.angry);
        }
        ...
        leaderSay( "But your plan was simply to take control of " + hisOrHer(castle.getLordGender()) + " mind. " +
                        "What is it you want Arabella, revenge?", FacialExpression.questioning);
        portraitSay("Revenge? I'm not that petty. I just want what I feel I deserve for my toils. " +
                "I'll settle for the " + castle.getLordTitle() + "'s kingdom.", FacialExpression.disappointed);
        ...
        leaderSay("You'll never have it. You'll be stopped and brought to justice!", FacialExpression.disappointed);
        portraitSay("Ha! Whatever makes you think so?", FacialExpression.wicked);
        leaderSay("You've confessed all your crimes! As soon as " + iOrWe() + " are freed, " +
                iOrWe() + "'ll arrest you!", FacialExpression.wicked);
        portraitSay("Oh you fool" + (model.getParty().size() > 1 ? "s" : "") + "! In a minute it won't matter. You " +
                "won't remember a thing!", FacialExpression.relief);
        leaderSay("What are you talking about?", FacialExpression.questioning);
        portraitSay("You see this machine behind me? I am moments away from completing it. When activated, my mind-control " +
                "power will extend to the borders of the " + CastleLocation.placeNameToKingdom(castle.getPlaceName()) + " and perhaps beyond. " +
                "Every single sentient being will be under my control, doing my bidding!", FacialExpression.wicked);
        leaderSay("You're crazy!", FacialExpression.angry);
        portraitSay("No, just ambitious. If only I could have learned from the Quad themselves. The power I could have attained. " +
                "It would have let me control all four kingdoms, perhaps even the entire world!", FacialExpression.excited);
        ...
        if (willis != null) {
            partyMemberSay(willis, "You don't know what kind of power you're dealing with Arabella. " +
                    "That machine looks highly volatile!", FacialExpression.afraid);
        } else {
            leaderSay("Spoken like a true megalomaniac.", FacialExpression.disappointed);
        }
        ...
        portraitSay("As soon as I insert this into the device... Well, let's just say you won't be so recalcitrant anymore. " +
                "You'll be my loyal subject!", FacialExpression.wicked);
        ...
        if (wiggler != model.getParty().getLeader()) {
            ...
            leaderSay("Quickly " + wiggler.getFirstName() + ", free the rest of us!", FacialExpression.angry);
            ...
            portraitSay("Gotcha!", FacialExpression.excited);
