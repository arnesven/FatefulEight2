...
public class HalfOrc extends Race {
    protected HalfOrc() {
        super("Half-Orc", MyColors.ORC_GREEN, 1, -1, 25,
                ...
                "Half‑orcs are a race formed over millennia of sporadic interbreeding " +
                        "between Orcs and Humans, and in some cases Elves or Dwarves. They are hardy, stout, rugged " +
