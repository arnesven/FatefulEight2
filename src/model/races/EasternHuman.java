...
public class EasternHuman extends HumanRace {
    ...
    public static final List<CharacterEyes> EYES = List.of(
            new CharacterEyes(0x1AF, 0x1BF, "", 6, 4, false),
            new CharacterEyes(0x1CF, 0x1DF, "", 6, 4, false),
            new CharacterEyes(0x1EF, 0x1FF, "", 6, 4, false),
            new CharacterEyes(0x19D, 0x19E, "", 6, 4, false)
    );
    ...
    public EasternHuman() {
        super("Human", MyColors.BEIGE,
                new Skill[]{Skill.Persuade, Skill.SeekInfo, Skill.UnarmedCombat},
