...
import model.items.treasures.TopazTreasureItem;
...
public class TopazGeodeObject extends GeodeRockObject {
    private static final MyColors LINE_COLOR = MyColors.GOLD;
    private static final MyColors FILL_COLOR = MyColors.YELLOW;
    ...
    public TopazGeodeObject() {
        super("Topaz", 10, FLOATING_SPRITE);
