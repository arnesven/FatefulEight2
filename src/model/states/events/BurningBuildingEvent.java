...
public class BurningBuildingEvent extends PersonalityTraitEvent {
    ...
    protected void doEvent(Model model) {
        // FEATURE: mini image subview, otherwise this event activates on top of town subview.
        showEventCard("You're strolling down the street, when suddenly you hear loud shouts.");
