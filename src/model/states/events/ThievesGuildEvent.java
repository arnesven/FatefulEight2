...
public class ThievesGuildEvent extends DailyEventState {
    ...
    protected void doEvent(Model model) {
        ...
        println("Guild Master: \"In fact, we could use a few extra hands on the heist...\"");
        ...
        if (modifier >= 0) {
            ...
            println("Guild Master: \"You lot look like you're the right kind of scoundrels for " +
                    "this type of thing. Are you in?\"");
            print("Are you? (Y/N) ");
            if (yesNoInput()) {
                println("Guild Master: \"That's what I like to hear. Which part of the heist do you think " +
