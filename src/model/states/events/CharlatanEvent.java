...
public class CharlatanEvent extends DailyEventState {
    ...
    protected void doEvent(Model model) {
        ...
        println("Doctor: \"... yes, it's true, this elixir will cure your stomach ailments sir. But not only that! " +
                "Have a problem with warts madam? The elixir will remove them for you!\"");
        println("Doctor: \"In fact, my famous draft will cure just about anything. And it tastes good too!\"");
        println("Doctor: \"Only available here and now! For the incredible price of just 20 gold pieces, you may " +
        ...
        println("\"I guarantee it ladies and " +
        ...
        if (model.getParty().getGold() < 20) {
            ...
            if (yesNoInput()) {
                ...
                println("Doctor: \"A bargain, I guarantee.\"");
    ...
    private void charlatanFoundOut(Model model, GameCharacter gc, SkillCheckResult result) {
        ...
        println("Angry Commoner: \"" + heOrSheCap(gc.getGender()) + " is right. It is juice!\"");
