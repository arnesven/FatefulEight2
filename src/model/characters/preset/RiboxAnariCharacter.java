...
public class RiboxAnariCharacter extends PresetCharacter {
    public RiboxAnariCharacter() {
        super("Ribox", "Anari", WOOD_ELF, MIN,
                ...
                SunblazeCastle.CASTLE_NAME,
                List.of(PersonalityTrait.irritable, PersonalityTrait.aggressive, PersonalityTrait.friendly),
                "A strong and lithe elf, hot-tempered, but otherwise warm and friendly. Ribox is from");
    }
}
