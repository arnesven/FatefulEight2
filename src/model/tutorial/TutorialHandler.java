...
public class TutorialHandler implements Serializable {
    ...
    public void scrolls(Model model) {
        runOnce("scrolls", () -> {
            model.getLog().waitForAnimationToFinish();
            model.transitionToDialog(new TutorialScrolls(model.getView()));
        });
    }
    ...
    public void robberies(Model model) {
        runOnce("robberies", () -> {
            model.getLog().waitForAnimationToFinish();
            model.transitionToDialog(new TutorialRobberies(model.getView()));
        });
    }
    ...
    public void tutorialCombat(Model model) {
        runOnce("tutorialcombat", () -> {
            model.getLog().waitForAnimationToFinish();
            model.transitionToDialog(new CombatHelpChapter(model.getView()));
        });
    }
