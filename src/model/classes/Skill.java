...
public enum Skill implements Comparable<Skill> {
    Acrobatics("Acrobatics", "Ac","acrobatic and athletic activities, like climbing, jumping, swimming, tumbling, running and crawling.\n\nSpecifically this skill is used in combat to avoid opportunity attacks when a character is moving from front formation to back."),       // 12
    Axes("Axes", "Ax","handling all types of axes, both during common work and in combat."),                   // 1
    Blades("Blades", "Bla", "handling and fighting with all types of bladed weapons, from daggers to claymores."),               // 3
    BluntWeapons("Blunt Weapons", "Blu", "handling and fighting with blunt weapons, like clubs, maces, hammers, flails and staffs."),  // 0
    ...
    Labor("Labor", "La", "all kinds of day-to-day work, like chopping wood, mending garments, plowing fields, painting a house or repairing a fence."),                 // 9
    Leadership("Leadership", "Le", "leading and inspiring other individuals.\n\nSpecifically this skill is used by the leader of the party at quest decision points and during flee attempts in combat."),       // 4
    Logic("Logic", "Lo", "representing a persons capacity for reasoning and deduction, and to some degree knowledge. This skill is also used for representing a person's memory."),                 // 13
    MagicBlack("Magic (Black)", "MK", "knowledge about black magic. Black magic is associated with darkness, death, decay and emptiness."),    // 1
    MagicBlue("Magic (Blue)", "MB", "knowledge about blue magic. Blue magic is associated with alteration, illusions, thinking and the element of water."),      // 2
    MagicGreen("Magic (Green)", "MG", "knowledge about green magic. Green magic is associated with nature, change, growth and the element of earth."),    // 1
    MagicRed("Magic (Red)", "MR", "knowledge about red magic. Red magic is associated with destruction, chaos and the element of fire."),        // 0
    MagicWhite("Magic (White)", "MW", "knowledge about white magic. White magic is associated with light, healing, warmth and the element of air."),    // 1
    MagicAny("Magic (Any)", "MA", "knowledge about any magic.\n\nCharacters do not have ranks in this skill. When a game effect refers to this skill it uses the character's best rank from any of Black, Blue, Green, Red or White magic."),        // 3
    ...
    Polearms("Polearms", "Po", "handling spears, glaives, halberds, pikes and the like."),           // 1
    ...
    SeekInfo("Seek Info", "See", "represents a character's ability to find information in towns or other urban locations. This may include figuring out who to talk to and what questions to ask, and even how to speak to people to get the most information out of them."),          // 13
    Sneak("Sneak", "Sne", "moving covertly and hiding."),                 // 13
    SpellCasting("Spell Casting", "Spe", "casting spells.\n\nA character's rank in this skill is added to each skill check when that character is attempting to cast a spell."),  // 3
