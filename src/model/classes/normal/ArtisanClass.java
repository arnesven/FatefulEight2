...
public class ArtisanClass extends CharacterClass {
    ...
    public AvatarSprite getAvatar(Race race, CharacterAppearance appearance) {
        return new AvatarSprite(race, appearance.getGender() ? 0x200 : 0x1E0, MyColors.LIGHT_BLUE, race.getColor(), MyColors.BROWN, appearance.getNormalHair(), appearance.getFullBackHair());
    }
